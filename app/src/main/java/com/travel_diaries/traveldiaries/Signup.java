...
public class Signup extends AppCompatActivity {
    ...
    EditText etName, etUsername, etEmail, etMobile, etPassword, etRePass;
    String name, username, email,  mobile, password, repassword;
        ...
        regist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.length() == 0 || username.length() == 0 || mobile.length() == 0 || password.length() == 0 || repassword.length() == 0) {
                    ...
                    Toast.makeText(Signup.this, "None of the fields can be left blank", Toast.LENGTH_SHORT).show();
                }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, SERVER_ADDRESS + "Register.php",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Intent reg = new Intent(Signup.this, MainActivity.class);
                        startActivity(reg);
                        finish();
                        progressDialog.dismiss();
                    }
